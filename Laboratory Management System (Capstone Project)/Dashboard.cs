...
namespace Laboratory_Management_System__Capstone_Project_
{
    public partial class Dashboard : Form
    {
        ...
        //private TransparentForm transparentForm; // Class-level variable for TransparentForm

        private void borrowTransactionToolStripMenuItem_Click(object sender, EventArgs e)
        {
            BorrowingApparatus borrowing = new BorrowingApparatus();
            ShowRestrictedForm(borrowing);
        }
